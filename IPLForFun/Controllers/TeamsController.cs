...
namespace IPLForFun.Controllers
{
    ...
    public class TeamsController : BaseController
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "TeamId,Name,Code")] Team team)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "TeamId,Name,Code")] Team team)
        {
            if (ModelState.IsValid)
            {
